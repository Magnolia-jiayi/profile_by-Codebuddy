...
// 作品集编辑器
export const PortfolioEditor = ({ data, setData, learningNotes, setLearningNotes, onCancel }) => {
  const addItem = () => {
    setData([
      ...data,
      {
  ...
  return (
    <div className="bg-neutral-50 rounded-xl p-6 space-y-6 border-2 border-primary-300">
      ...
      {/* 学习复盘编辑 */}
      <div className="bg-white rounded-xl p-5 space-y-4 shadow-sm border border-neutral-200">
        <h4 className="text-md font-semibold text-neutral-800">学习复盘入口</h4>
        <div>
          <label className="block text-sm font-medium text-neutral-700 mb-2">标题</label>
          <input
            type="text"
            value={learningNotes.title}
            onChange={(e) => setLearningNotes({ ...learningNotes, title: e.target.value })}
            className="w-full px-4 py-2.5 border border-neutral-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent"
          />
        </div>
        <div>
          ...
          <textarea
            value={learningNotes.description}
            onChange={(e) => setLearningNotes({ ...learningNotes, description: e.target.value })}
            rows={2}
            className="w-full px-4 py-2.5 border border-neutral-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent"
          />
        </div>
        <div>
          ...
          <input
            type="text"
            value={learningNotes.feishuUrl}
            onChange={(e) => setLearningNotes({ ...learningNotes, feishuUrl: e.target.value })}
            className="w-full px-4 py-2.5 border border-neutral-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent"
          />
        </div>
      </div>
